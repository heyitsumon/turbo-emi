<div class="max-w-3xl mx-auto p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold">{{ __('ui.locations_title') }}</h2>
    ...
    <div class="card bg-base-100 shadow p-4 mb-6">
        <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}">
            <div class="form-control mb-3">
                <label class="label font-semibold">{{ __('ui.location_name') }}</label>
                <input type="text" wire:model.defer="name" class="input input-bordered w-full" placeholder="{{ __('ui.enter_location') }}">
        ...
        <div class="overflow-x-auto">
            <table class="table table-zebra w-full">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center text-gray-400">{{ __('ui.no_locations') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
